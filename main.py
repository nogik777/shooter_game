...
while game_is_running:
    ...
    if fighter_is_moving_left and fighter_x >= STEP_FIGHTER:
        fighter_x -= STEP_FIGHTER
    if fighter_is_moving_right and fighter_x <= screen_width - fighter_width - STEP_FIGHTER:
        fighter_x += STEP_FIGHTER
